...
const fetchUpdateAdoptionRequestStatus = async (
   request: Request,
   id: string
) => {
   ...
   try {
      ...
      return NextResponse.json(
         {
            message:
               "Erreur lors de la modification du status de la demande d'adoption.",
            error: error.message,
         },
         { status: 500 }
      );
...
export default fetchUpdateAdoptionRequestStatus;
