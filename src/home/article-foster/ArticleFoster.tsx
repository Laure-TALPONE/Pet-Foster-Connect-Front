      ...
      <div className={styles.article}>
         <div className={styles.text}>
            ...
            <div className={styles.details}>
               ...
               d'accueil et associations de protection animale pour assurer le
               bien-être des animaux en attente d’adoption.
               <br />
               ...
               <ul>
                  ...
                  <li>
                     Trouvez rapidement une famille d’accueil pour vos protégés.
                  </li>
                  <li>
                     Créez un réseau solidaire au service de la cause animale.
                  </li>
                  <li>
