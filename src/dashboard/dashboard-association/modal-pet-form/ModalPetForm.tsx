...
const ModalPetForm = () => {
   ...
   const typeAnimal = ['Chat', 'Chien', 'Nac', 'Oiseau'];
   ...
   const renderTypesAnimal = useMemo(() => {
      return (
         <ul>
            {typeAnimal.map((type: string, index: number) => (
         ...
         <form>
            ...
            <div className={styles.form}>
               ...
               <section className={styles.type}>
                  <div className="m-select m-select__background m-select__label">
                     <label>Espèce de l’animal* :</label>
                     <input type="text" readOnly onClick={handleOpenSelect} />
